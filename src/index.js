...
export const withSmartKnobs = (story, context) => {
  ...
  // for compatibility with @kadira/react-storybook-addon-info
  if (component.type.name === 'WrapStory') {
    const actualComponent = component.props.storyFn(context).props.children
